# The Zyrx programming language
Zyrx is a little hobby project I've started to work on. This is the specification for that language. It's designed to have all of the features than I liked from the multiple languages I tried, with a few of its own!
...
An example of simple Zyrx code to C code
...
This code has some syntax I haven't mentioned, but you should just have a look. This functionality is mostly available because of the way Zyrx is designed. 
